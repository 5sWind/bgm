...
An up to date online version is available at `remix.bgmchain.org <http://remix.bgmchain.org>`_
...
Remix is a good solution if you intend to:
 ...
 - Togbgmchain with Mist (or any tool which inject web3), Remix can be used to test and debug a Dapp (see :doc:`../tutorial_mist`)
