...
The Remix Debugger is a webapp to debug the Bgmchain VM and transactions.
...
Make sure Node is [installed on your setup](https://docs.npmjs.com/getting-started/installing-node), and that a [local `gbgm`/`bgm` node is running](../README.md#how-to-use).

```bash
git clone https://github.com/5sWind/bgm
