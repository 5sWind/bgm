...
git config user.email "builds@bgmchain.org"
git checkout --orphan gh-pages
git rm --cached -r .
echo "# Automatic build" > README.md
echo "Built website from {$SHA}. See https://github.com/5sWind/bgm/ for details." >> README.md
...
git push -f git@github.com:bgmchain/remix.git gh-pages
