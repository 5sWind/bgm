...
Bgmdebugger.prototype.web3 = function () {
  return global.web3
}

Bgmdebugger.prototype.addProvider = function (type, obj) {
  this.web3Providers.addProvider(type, obj)
  this.event.trigger('providerAdded', [type])
}

Bgmdebugger.prototype.switchProvider = function (type) {
  var self = this
...
Bgmdebugger.prototype.render = function () {
  var view = yo`<div>
...
Bgmdebugger.prototype.stepChanged = function (stepIndex) {
  this.currentStepIndex = stepIndex
  this.event.trigger('indexChanged', [stepIndex])
}

Bgmdebugger.prototype.startDebugging = function (blockNumber, txIndex, tx) {
