...
describe('Misc', function () {
  ...
  it('should get protocol version', async function () {
    web3._requestManager.send({method: 'bgm_protocolVersion', params: []}, (err, result) => {
      if (err) {
        throw new Error(err)
      }
