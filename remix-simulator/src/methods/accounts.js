...
var Accounts = function () {
  ...
  this.accounts = [this.web3.bgm.accounts.create(['abcd']), this.web3.bgm.accounts.create(['ef12']), this.web3.bgm.accounts.create(['ef34'])]
...
Accounts.prototype.methods = function () {
  return {
    bgm_accounts: this.bgm_accounts.bind(this)
  }
}

Accounts.prototype.bgm_accounts = function (payload, cb) {
