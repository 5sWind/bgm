...
tape('CodeManager', function (t) {
  ...
  web3Providers.get('TEST', function (error, obj) {
    if (error) {
      ...
      var contractCode = web3.bgm.getCode('0x0d3a18d64dfe4f927832ab58d6451cecc4e517c5')
      ...
      var tx = web3.bgm.getTransaction('0x20ef65b8b186ca942fcccd634f37074dde49b541c27994fc7596740ef44cfd51')
