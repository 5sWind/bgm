...
/**
  * Bgmdebugger is a wrapper around a few classes that helps debugging a transaction
  *
...
Bgmdebugger.prototype.setManagers = function () {
  this.traceManager = new TraceManager({web3: this.web3})
  this.codeManager = new CodeManager(this.traceManager)
  this.solidityProxy = new SolidityProxy(this.traceManager, this.codeManager)
  this.storageResolver = null
...
Bgmdebugger.prototype.resolveStep = function (index) {
  this.codeManager.resolveStep(index, this.tx)
}

Bgmdebugger.prototype.setCompilationResult = function (compilationResult) {
...
Bgmdebugger.prototype.sourceLocationFromVMTraceIndex = function (address, stepIndex, callback) {
...
Bgmdebugger.prototype.sourceLocationFromInstructionIndex = function (address, instIndex, callback) {
...
/* breakpoint */
Bgmdebugger.prototype.setBreakpointManager = function (breakpointManager) {
  this.breakpointManager = breakpointManager
}

/* decode locals */
Bgmdebugger.prototype.extractLocalsAt = function (step, callback) {
  callback(null, this.callTree.findScope(step))
}

Bgmdebugger.prototype.decodeLocalsAt = function (step, sourceLocation, callback) {
...
/* decode state */
Bgmdebugger.prototype.extractStateAt = function (step, callback) {
  this.solidityProxy.extractStateVariablesAt(step, function (error, stateVars) {
    callback(error, stateVars)
  })
}

Bgmdebugger.prototype.decodeStateAt = function (step, stateVars, callback) {
...
Bgmdebugger.prototype.storageViewAt = function (step, address) {
...
Bgmdebugger.prototype.updateWeb3 = function (web3) {
  this.web3 = web3
  this.setManagers()
}

Bgmdebugger.prototype.debug = function (tx) {
...
Bgmdebugger.prototype.unLoad = function () {
