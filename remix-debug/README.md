...
remix-debug wrap other remix-* libraries and can be used to debug Bgmchain transactions.
...
```javascript
var Debugger = require('remix-debug').BgmDebugger
...
`BreakpointManager(_bgmdebugger, _locationToRowConverter)` :
